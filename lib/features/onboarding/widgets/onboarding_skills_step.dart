      ...
      children: [
        Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              const Text('What can you already do?',
                ...
                Wrap(
                  ...
                  children: skills.userSkills
                      .map((s) => Chip(
                            ...
                            onDeleted: userId == null ? null : () => skills.removeSkill(userId, s.id),
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(onPressed: widget.onContinue, child: const Text('Skip for now')),
            ],
          ),
        ),
      ],
